...
The team wants to explore the loan amount distribution based on education level.  On our website, the user just needs to use the filter to filter out different terms and it can show the boxplots of different education levels. It would show the median loan amount directly.
